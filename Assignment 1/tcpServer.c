...
// The following three files are needed for network programming //
...
int main()
{
    ...
    */
    ...
    // With the information provided in serv_addr, we associate the server with its port using the bind() system call //
